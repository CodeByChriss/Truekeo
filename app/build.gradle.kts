...
dependencies {
    ...
    implementation("com.mapbox.search:autofill:2.17.1")
    implementation("com.mapbox.search:discover:2.17.1")
    implementation("com.mapbox.search:place-autocomplete:2.17.1")
    implementation("com.mapbox.search:offline:2.17.1")
